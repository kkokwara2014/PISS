...
@section('title')
 Yearly Report for {{ date('Y',strtotime($specificyear->created_at)) }}
@endsection
    ...
    <section class="col-lg-12 connectedSortable">
        ...
        <div class="row">
            <div class="col-md-12">
                <div>
                    <p>
                        <a href="{{ route('daily') }}" class="btn btn-danger btn-sm"><span class="fa fa-bar-chart"></span> Daily Report</a>
                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        <table id="example1" class="table table-bordered table-striped table-responsive">
                            ...
                            <tbody>
                                @foreach ($yearlyreports as $transaction)
                ...
                @else
                <p>
                    <span class="badge badge-pill badge-danger" style="background-color: red;color: seashell">There is no report for this Year!</span>
                </p>
                @endif
