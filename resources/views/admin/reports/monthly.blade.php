    ...
    <section class="col-lg-12 connectedSortable">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        <table id="example1" class="table table-bordered table-striped table-responsive">
                            ...
                            <tbody>
                                @foreach ($monthlyreports as $transaction)
                ...
                @else
                <p>
                    <span class="badge badge-pill badge-danger" style="background-color: red;color: seashell">There is no report for this Month!</span>
                </p>
                @endif
