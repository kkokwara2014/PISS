                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="lastname" type="text"
                                            ...
                                            name="lastname" value="{{ $staff->lastname }}" required
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input id="email" type="email"
                                            ...
                                            name="email" value="{{ $staff->email }}" required placeholder="Email">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="phone" type="tel"
                                            ...
                                            name="phone" value="{{ $staff->phone }}" required placeholder="Phone"
